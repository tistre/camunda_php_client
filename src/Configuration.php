...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost:8080/engine-rest';
    ...
    {
        $report  = 'PHP SDK (StrehleDe\CamundaClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 7.13.0' . PHP_EOL;
