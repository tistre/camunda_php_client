...
/**
 * ExternalTaskQueryDtoSorting Class Doc Comment
 *
 * @category Class
 * @package  StrehleDe\CamundaClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ExternalTaskQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalTaskQueryDto_sorting';
    ...
    const SORT_BY_ID = 'id';
    const SORT_BY_LOCK_EXPIRATION_TIME = 'lockExpirationTime';
    ...
    const SORT_BY_TASK_PRIORITY = 'taskPriority';
