...
/**
 * MissingAuthorizationDto Class Doc Comment
 *
 * @category Class
 * @package  StrehleDe\CamundaClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MissingAuthorizationDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MissingAuthorizationDto';
     ...
     *
     * @param string|null $permission_name The permission name that the user is missing.
     *
     * @return $this
     */
     ...
     * Sets resource_name
     *
     * @param string|null $resource_name The name of the resource that the user is missing permission for.
     *
     * @return $this
     */
     ...
     * Sets resource_id
     *
     * @param string|null $resource_id The id of the resource that the user is missing permission for.
     *
     * @return $this
     */
