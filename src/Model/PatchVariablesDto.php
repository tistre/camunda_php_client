...
class PatchVariablesDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchVariablesDto';
    ...
    protected static $openAPITypes = [
        'modifications' => 'map[string,\StrehleDe\CamundaClient\Model\VariableValueDto]',
        'deletions' => 'string[]'
    ];
     ...
     * Sets modifications
     *
     * @param map[string,\StrehleDe\CamundaClient\Model\VariableValueDto]|null $modifications A JSON object containing variable key-value pairs.
     *
     * @return $this
     */
     ...
     * Sets deletions
     *
     * @param string[]|null $deletions An array of String keys of variables to be deleted.
     *
     * @return $this
     */
