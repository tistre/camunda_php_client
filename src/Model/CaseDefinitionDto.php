...
class CaseDefinitionDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CaseDefinitionDto';
     ...
     * Sets id
     *
     * @param string|null $id The id of the case definition
     *
     * @return $this
     */
     ...
     * Sets key
     *
     * @param string|null $key The key of the case definition, i.e., the id of the CMMN 2.0 XML case definition.
     *
     * @return $this
     */
     ...
     * Sets category
     *
     * @param string|null $category The category of the case definition.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the case definition.
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param int|null $version The version of the case definition that the engine assigned to it.
     *
     * @return $this
     */
     ...
     * Sets resource
     *
     * @param string|null $resource The file name of the case definition.
     *
     * @return $this
     */
     ...
     * Sets deployment_id
     *
     * @param string|null $deployment_id The deployment id of the case definition.
     *
     * @return $this
     */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id The tenant id of the case definition.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $history_time_to_live History time to live value of the case definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.13/user-guide/process-engine/history/#history-cleanup).
     *
     * @return $this
     */
    public function setHistoryTimeToLive($history_time_to_live)
    {
        ...
        if (!is_null($history_time_to_live) && ($history_time_to_live < 0)) {
            throw new \InvalidArgumentException('invalid value for $history_time_to_live when calling CaseDefinitionDto., must be bigger than or equal to 0.');
        }
