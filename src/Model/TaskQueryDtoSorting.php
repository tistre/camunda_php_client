...
class TaskQueryDtoSorting implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'sort_by' => 'string',
        'sort_order' => 'string',
        'parameters' => '\StrehleDe\CamundaClient\Model\SortTaskQueryParametersDto'
    ];
     ...
     * Gets parameters
     *
     * @return \StrehleDe\CamundaClient\Model\SortTaskQueryParametersDto|null
     */
     ...
     * Sets parameters
     *
     * @param \StrehleDe\CamundaClient\Model\SortTaskQueryParametersDto|null $parameters parameters
     *
     * @return $this
     */
