...
/**
 * StartProcessInstanceFormDto Class Doc Comment
 *
 * @category Class
 * @package  StrehleDe\CamundaClient
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class StartProcessInstanceFormDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StartProcessInstanceFormDto';
     ...
     * Sets business_key
     *
     * @param string|null $business_key The business key the process instance is to be initialized with. The business key uniquely identifies the process instance in the context of the given process definition.
     *
     * @return $this
     */
