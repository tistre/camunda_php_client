...
class ExecutionDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExecutionDto';
     ...
     * Sets id
     *
     * @param string|null $id The id of the Execution.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $process_instance_id The id of the root of the execution tree representing the process instance.
     *
     * @return $this
     */
     ...
     * Sets ended
     *
     * @param bool|null $ended Indicates if the execution is ended.
     *
     * @return $this
     */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id The id of the tenant this execution belongs to. Can be `null` if the execution belongs to no single tenant.
     *
     * @return $this
     */
